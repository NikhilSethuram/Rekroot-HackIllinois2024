...
class IndeedBot:
    ...
    def find_express_jobs(self):
        ...
        self.jobs = self.driver.find_elements(By.CLASS_NAME, "jobsearch-SerpJobCard")
    ...
    def __process_apply_button(self):
            apply_button = self.driver.find_element(By.ID, 'indeedApplyButtonContainer')
            apply_button.click()
            time.sleep(4)
