...
import { StyleSheet, Text, View, TouchableOpacity, SafeAreaView, Alert, Platform, ScrollView } from 'react-native';
import { NavigationContainer } from '@react-navigation/native';
import { createNativeStackNavigator } from '@react-navigation/native-stack';
import { LinearGradient } from 'expo-linear-gradient';
import * as DocumentPicker from 'expo-document-picker';
import { Picker } from '@react-native-picker/picker';
import jobInterestsData from '/Users/ishan/AwesomeProject/data/job_interests.json'; // Ensure this path matches where your job_interests.json is located
...
const LocationSelectScreen = ({ navigation }) => {
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <TouchableOpacity style={styles.confirmButton} onPress={navigateToNewScreen}>
  ...
  return (
    <NavigationContainer>
      ...
      >
        ...
        <Stack.Screen name="UploadResume" component={UploadResumeScreen} options={{ title: 'Upload Resume' }} />
        <Stack.Screen name="JobInterests" component={JobInterestsScreen} options={{ title: 'Select Interests' }} />
